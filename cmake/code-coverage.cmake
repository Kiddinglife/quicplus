...
# Code coverage is the detailing of, during the execution of a binary, which regions, functions, or lines of code are actually executed.
# This can be used in a number of ways, from figuring out areas that automated testing is lacking or not touching, to giving a user an
# instrumented binary to determine which areas of code are used most/least to determine which areas to focus on.
# Although this does come with the caveat that coverage is no guarantee of good testing, just of what code has been.
# Coverage here is supported on both GCC and Clang. GCC requires the lcov program, and Clang requires llvm-cov and llvm-profdata
# often provided with the llvm toolchain. To enable, turn on the CODE_COVERAGE variable.
...
if(NOT LLVM_COV_PATH)
  find_program(LLVM_COV_PATH llvm-cov-12)
  find_program(LLVM_PROFDATA_PATH llvm-profdata-12)
  find_program(LCOV_PATH lcov-12)
  find_program(GENHTML_PATH genhtml-12)
else()
